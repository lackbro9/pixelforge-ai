...
"use strict";
var BASE = (function () {
  var s = document.querySelector('script[src$="js/components.js"]');
...
function headerTemplate() {
  ...
  var navHtml = NAV_LINKS.map(function (l) {
    var current = path.slice(-(l.href.length + 1)) === ("/" + l.href) ? ' aria-current="page"' : "";
    return '<li><a href="' + BASE + l.href + '"' + current + '>' + l.label + '</a></li>';
  }).join("");
  return (
    '<div class="container header-inner">' +
    '<a class="logo" href="' + BASE + 'index.html"><span class="logo-mark">PF</span>PixelForge AI</a>' +
    '<nav class="main-nav" aria-label="Primary"><ul>' + navHtml + '</ul></nav>' +
    '<div class="header-actions">' +
    '<form class="header-search" role="search" action="' + BASE + 'tools.html" method="get">' +
...
function footerTemplate() {
  ...
  return (
    ...
    '<div class="footer-col"><a class="logo" href="' + BASE + 'index.html"><span class="logo-mark">PF</span>PixelForge AI</a>' +
    '<p>Practical, honest image and creative tools that run in your browser wherever possible. No gimmicks, no fake results.</p></div>' +
    '<div class="footer-col"><h4>Product</h4><ul><li><a href="' + BASE + 'tools.html">All Tools</a></li><li><a href="' + BASE + 'ai-tools.html">AI Tools</a></li><li><a href="' + BASE + 'pricing.html">Pricing</a></li></ul></div>' +
    '<div class="footer-col"><h4>Company</h4><ul><li><a href="' + BASE + 'about.html">About</a></li><li><a href="' + BASE + 'contact.html">Contact</a></li></ul></div>' +
    '<div class="footer-col"><h4>Legal</h4><ul><li><a href="' + BASE + 'privacy.html">Privacy Policy</a></li><li><a href="' + BASE + 'terms.html">Terms of Service</a></li></ul></div>' +
    '</div>' +
