...
"use strict";
var BASE = (function () {
  var s = document.querySelector('script[src$="js/tools-index.js"]');
  var src = s ? s.getAttribute("src") : "";
  return src.replace(/js\/tools-index\.js$/, "");
})();
...
fetch(BASE + "data/tools.json").then(function (r) { return r.json(); }).then(function (data) {
